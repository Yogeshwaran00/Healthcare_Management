...
<tr>
    <td colspan="4" style="padding-top: 10px;">
        <p class="heading-main12" style="margin-left: 45px;font-size: 20px;color: blue;">My Reports:</p>
    </td>
</tr>
    ...
    <td colspan="4">
        <center>
            <div class="abc scroll">
                <table width="100%" class="sub-table scrolldown" border="0" style="padding: 5px;border:none">
                    <tbody>
                        <?php
                            if ($result->num_rows == 0) {
                                    ...
                                    <td colspan="4">
                                        ...
                                        <center>
                                            ...
                                            <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">
                                                We couldn\'t find any sessions related to your keywords!
                                            </p>
                                ...
                                // Display each session fetched from the database
                                            ...
                                            <td style="width: 25%;">
                                                <div class="dashboard-items search-items">
                                                    <div style="width:100%">
                                                        ...
                                                        <br>
                                                        <a href="view_report.php?id=' . $scheduleid . '">
